...
vim.keymap.set("n", "<leader>os", ":Telescope find_files search_dirs={\"~/SecondBrain/notes\"}<cr>")
vim.keymap.set("n", "<leader>oz", ":Telescope live_grep search_dirs={\"~/SecondBrain/notes\"}<cr>")
--
-- search for files in notes (ignore zettelkasten)
-- vim.keymap.set("n", "<leader>ois", ":Telescope find_files search_dirs={\"~/SecondBrain/notes\"}<cr>")
-- vim.keymap.set("n", "<leader>oiz", ":Telescope live_grep search_dirs={\"~/SecondBrain/notes\"}<cr>")
--
-- for review workflow
-- move file in current buffer to zettelkasten folder
vim.keymap.set("n", "<leader>ok", ":!mv '%:p' ~/SecondBrain/zettelkasten<cr>:bd<cr>")
